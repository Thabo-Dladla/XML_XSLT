...
- **recipes.xml** - Sample XML document containing recipe data
- **recipes.xsd** - XML Schema Definition for validating recipe documents
- **recipes.dtd** - Document Type Definition for the recipes XML structure
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/Thabo-Dladla/XML_XSLT.git
   cd XML_XSLT
   ```

2. **Explore the files** - Open any XML file with a text editor or XML-capable IDE

3. **Validate XML** - Use an XML validator to check documents against the XSD or DTD files
